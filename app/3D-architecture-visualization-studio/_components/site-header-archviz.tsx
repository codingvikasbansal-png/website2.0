      ...
      <div className="container mx-auto max-w-4xl">
        <div className="flex h-14 items-center justify-between px-6 liquid-glass-header rounded-full">
          ...
          <nav className="hidden items-center gap-6 text-sm text-white/90 md:flex">
            <NavigationMenu>
              <NavigationMenuList>
                <NavigationMenuItem>
                  <NavigationMenuTrigger
                    className="bg-transparent text-white/90 hover:text-red-400 data-[state=open]:text-red-400
                          ...
                          <NavigationMenuLink asChild>
                            <Link
                              ...
                              className="group relative flex items-start gap-3 rounded-xl p-3 transition-all
                                         hover:bg-white/5 hover:ring-1 hover:ring-red-400/60
                                         hover:shadow-[0_0_0_1px_rgba(232,3,8,0.25),0_0_20px_rgba(232,3,8,0.15)]
                                         focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-400/70"
                            >
                              <service.icon className="h-5 w-5 text-red-500 mt-0.5 shrink-0 group-hover:text-red-400" />
                              <div>
          ...
          <div className="hidden md:flex">
            <Button
              asChild
              className="bg-red-500 text-black font-medium rounded-lg px-6 py-2.5 hover:bg-red-400 hover:shadow-md hover:scale-[1.02] transition-all"
            >
              ...
              <SheetContent side="right" className="liquid-glass border-gray-800 p-0 w-64 flex flex-col">
                ...
                <nav className="flex flex-col gap-1 mt-2 text-gray-200">
                  <Collapsible open={servicesOpen} onOpenChange={setServicesOpen}>
                    <CollapsibleTrigger className="flex items-center justify-between w-full px-4 py-3 hover:bg-gray-900 hover:text-red-400 transition-colors">
                    ...
                    <CollapsibleContent>
                      <div className="flex flex-col bg-gray-900/50 border-l-2 border-red-500/30 ml-4">
                        {services.map((service) => (
                          <Link
                            key={service.href}
                            href={service.href}
                            className="flex items-center gap-3 pl-8 pr-4 py-2.5 hover:bg-gray-900 hover:text-red-400 transition-colors"
                          >
                            <service.icon className="h-4 w-4 text-red-500/70" />
                ...
                <div className="mt-auto border-t border-gray-800 p-4">
                  <Button
                    asChild
                    className="w-full bg-red-500 text-black font-medium rounded-lg px-6 py-2.5 hover:bg-red-400 hover:shadow-md hover:scale-[1.02] transition-all"
                  >
                    <Link href="https://wa.link/65mf3i" target="_blank">
                      Start a Project
                    </Link>
