...
export function HeroArchviz() {
  const cta = (
    <Button asChild className="rounded-full bg-red-500 px-6 text-black hover:bg-red-400">
      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col items-center justify-center py-14 sm:py-20">
          <div className="mb-5 flex items-center gap-2">
            <Image src="/logo.png" alt="Skitbit logo" width={32} height={32} className="h-8 w-8" />
            <p className="text-sm uppercase tracking-[0.25em] text-red-400/80">archviz</p>
          </div>

          {/* H1 */}
          <h1 className="mt-3 text-center text-4xl font-extrabold tracking-tight sm:text-5xl md:text-6xl">
            <span className="block">PHOTO‑REALISTIC</span>
            <span className="block text-red-400 drop-shadow-[0_0_20px_rgba(232,3,8,0.35)]">ARCHITECTURE</span>
