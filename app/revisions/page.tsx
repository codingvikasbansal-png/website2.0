        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="relative overflow-hidden rounded-3xl border border-neutral-800 bg-[#0f0f0f] p-6 sm:p-10 shadow-xl">
              <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_top_left,rgba(96,165,250,0.10),transparent_55%)]" />
              <div className="relative space-y-12">
                <header className="space-y-4">
                  <h1 className="text-4xl font-bold tracking-tight text-blue-400">Revision Policy</h1>
                ...
                <section className="space-y-3">
                  ...
                  <p className="text-neutral-300">
                    Email: <a href="mailto:hello@theskitbit.com" className="text-blue-400 underline">hello@theskitbit.com</a>
                  </p>
                </section>
              </div>
            </div>
